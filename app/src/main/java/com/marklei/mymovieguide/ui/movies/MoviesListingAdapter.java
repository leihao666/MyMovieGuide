...
import com.marklei.mymovieguide.shared.Api;
...
public class MoviesListingAdapter extends RecyclerView.Adapter<MoviesListingAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            MoviesListingAdapter.this.view.showMovieDetailsUi(movie);
        }
    }

    public MoviesListingAdapter(List<Movie> movies, MoviesContract.View moviesView) {
        this.movies = movies;
        view = moviesView;
    }
